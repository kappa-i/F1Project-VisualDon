...
const assetItems: AnimatedListItem[] = [
  ...
  createFooterListItem('asset-turbosquid', 'TurboSquid', 'Modèle voiture Haas 2026 utilisé dans le projet', 'https://www.turbosquid.com/FullPreview/2534860', <Box aria-hidden="true" />),
  createFooterListItem('asset-figma', 'Wireframes Figma', 'Structure du projet et hiérarchie visuelle', 'https://www.figma.com/design/NScnLEtFSYWRrBWTcuhv4b/F1Project?node-id=0-1&t=meHIixZrsysDpq6a-1', <Box aria-hidden="true" />),
  createFooterListItem('asset-dribbble', 'Aston Martin F1', 'Inspiration interactive 3D scroll sur Dribbble', 'https://dribbble.com/shots/25945471-Aston-Martin-F1-Interactive-3D-Scroll', <Box aria-hidden="true" />),
  createFooterListItem('asset-caraddict', 'CarAddict.ch', 'Référence UI automobile sombre et éditoriale', 'https://caraddict.ch/a-propos/', <Box aria-hidden="true" />),
  createFooterListItem('asset-viita', 'VIITA Race', 'Inspiration scroll horizontal et immersion racing', 'https://race.viita-watches.com/', <Box aria-hidden="true" />),
  createFooterListItem('asset-genz', 'Gen Z Broke the Marketing Funnel', 'Référence collage, typo et narration visuelle', 'https://genzbrokethefunnel.com', <Box aria-hidden="true" />),
  createFooterListItem('asset-bidwells', 'Bidwells', 'Référence design et communication technique', 'https://www.bidwells.co.uk/insights-reports-events/driving-innovation-at-speed/', <Box aria-hidden="true" />),
  createFooterListItem('asset-reactbits', 'React Bits', 'Bibliothèque de composants React interactifs', 'https://reactbits.dev/', <Box aria-hidden="true" />),
  createFooterListItem('asset-reactbits-pro', 'React Bits Pro', 'Version avancée des composants React Bits', 'https://pro.reactbits.dev/', <Box aria-hidden="true" />),
  createFooterListItem('asset-aceternity', 'Aceternity UI', 'Collection de composants React modernes', 'https://ui.aceternity.com/components', <Box aria-hidden="true" />),
  createFooterListItem('asset-magicui', 'Magic UI', 'Composants UI animés pour interfaces modernes', 'https://magicui.design/docs/components', <Box aria-hidden="true" />),
  createFooterListItem('asset-shadcn', 'shadcn/ui', 'Système de composants basé sur Radix UI', 'https://ui.shadcn.com/', <Box aria-hidden="true" />),
  createFooterListItem('asset-coss', 'COSS UI', 'Collection de composants UI interactifs', 'https://coss.com/ui/', <Box aria-hidden="true" />),
];
