...
import ClosingQuestion  from '../components/ClosingQuestion.tsx';
import CicatriceViz    from '../components/CicatriceViz.tsx';
...
mount('cicatrice-root',         React.createElement(CicatriceViz));
mount('conclusion-graph-root',  React.createElement(ConclusionGraph));
mount('closing-question-root',  React.createElement(ClosingQuestion));
